...
<div class="dropdown">
  <button class="w3-button w3-red">Consulta por ISBN</button>
  <div class="dropdown-content">
          <div class=""
    <div align="center">
          
			<form name="isbn" method="POST" action="busqueda_libro.php">

			Prestamos de libros por clave:<input type="text" name="prestamo" placeholder="Escriba el ISBN del libro" required/>

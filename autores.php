...
$sentencia = $conn->query("SELECT count(*) AS conteo FROM autor");
$conteo = $sentencia->fetchObject()->conteo;
# Para obtener las páginas dividimos el conteo entre los productos por página, y redondeamos hacia arriba
$paginas = ceil($conteo / $autoresPorPagina);

# Ahora obtenemos los productos usando ya el OFFSET y el LIMIT
$sentencia = $conn->prepare("SELECT id_autor, nombre_autor, apellido_autor FROM autor LIMIT ? OFFSET ?");
    ...
    <div class="col-xs-12">
        ...
        <table border="1" align="center"  >
            ...
            <tr>
                ...
                <th style="width:50%">NOMBRE(S) AUTOR</th>
                <th style="width:50%">APELLIDO(S) AUTOR</th>
